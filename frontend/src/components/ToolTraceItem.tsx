...
import type { ToolTraceItem as ToolTraceItemType } from "../types";

interface ToolTraceItemProps {
  tool: ToolTraceItemType;
...
const ToolTraceItem = React.memo(function ToolTraceItem({ tool, defaultExpanded = false }: ToolTraceItemProps) {
...
const ChatToolChip = React.memo(function ChatToolChip({ tool }: ChatToolChipProps) {
